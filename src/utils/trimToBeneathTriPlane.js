import { Plane, Vector3 } from 'https://cdn.skypack.dev/three@0.136.0';
import { isProjectedTriangleDegenerate } from './triangleLineUtils.js';
...
export function trimToBeneathTriPlane(tri, line, lineTarget, projectionVector = DEFAULT_UP_VECTOR) {
	...
	// if the plane is not facing the projection direction then flip the direction
	_plane.copy(tri.plane);
	if (_plane.normal.dot(projectionVector) < 0) {
